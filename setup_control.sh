...
runuser -u mikec123 -- ssh-keygen -q -t rsa -f /users/mikec123/.ssh/id_rsa -N ''
...
cp /users/mikec123/.ssh/id_rsa* /var/nfs/keys
...
# setup lamp
runuser -u mikec123 -- bash /local/repository/setup_ansible.sh
